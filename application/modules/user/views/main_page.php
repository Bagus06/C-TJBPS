								...
								<tr>
									...
									<td class="text-center py-0 align-middle">
										<div class="btn-group btn-group">
											...
											<a href="<?php echo base_url('user/delete/' . $value['id']) ?>" onclick="if(confirm('are you sure you want to delete <?php echo $value['username'] ?>')){}else{return false;};" class="btn btn-danger"><i class="fas fa-trash"></i></a>
										</div>
									</td>
								</tr>
								<?php $i++; ?>
